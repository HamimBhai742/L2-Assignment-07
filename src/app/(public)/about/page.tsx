...
import { Mail, Phone, MapPin, Globe, Github, Linkedin, Facebook, Calendar, User, Briefcase } from 'lucide-react';
            ...
            <div className="relative px-8 pb-8">
              <div className="flex flex-col md:flex-row items-center md:items-end -mt-20 mb-8">
                <div className="relative">
                  ...
                  />
                  <div className="absolute -bottom-2 -right-2 bg-green-500 w-8 h-8 rounded-full border-4 border-white dark:border-gray-800"></div>
                </div>
                
                <div className="md:ml-8 mt-4 md:mt-0 text-center md:text-left">
                  <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">{aboutData.name}</h1>
                  <p className="text-xl text-blue-600 dark:text-blue-400 font-semibold mb-2">{aboutData.profession}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-white font-medium">{aboutData.email}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-white font-medium">{aboutData.phone}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-white font-medium">{aboutData.address}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3">
              {aboutData.skills.map((skill, index) => (
                ...
                >
                  <span className="text-gray-800 dark:text-white font-medium text-sm">{skill}</span>
                </div>
              ))}
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <a href={aboutData.website} className="text-blue-600 dark:text-blue-400 hover:underline font-medium">
                      {aboutData.website}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-white font-medium">
                      {new Date(aboutData.createdAt).toLocaleDateString('en-US', { 
                        year: 'numeric', 
                        month: 'long' 
                      })}
                    </p>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">View my repositories</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Professional network</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <p className="text-gray-900 dark:text-white font-medium">Facebook</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Social updates</p>
                  </div>
                </a>
              </div>
            </div>
