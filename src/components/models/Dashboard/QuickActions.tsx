...
import { Plus, Edit, Eye, Settings, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="mt-12">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="text-sm text-gray-500 dark:text-gray-400">Choose an action to get started</div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {actions.map((action, index) => (
          ...
          >
            ...
            {/* Glow effect */}
            <div className={`absolute -inset-1 bg-gradient-to-r ${action.gradient} opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300`}></div>
            ...
            <div className="relative">
              ...
              <div>
                <h3 className="font-bold text-gray-900 dark:text-white group-hover:text-gray-700 dark:group-hover:text-gray-100 transition-colors mb-2">
                  {action.title}
                </h3>
