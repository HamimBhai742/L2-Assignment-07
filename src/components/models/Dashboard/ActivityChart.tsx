...
export default function ActivityChart({ stats }: ActivityChartProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl p-8 shadow-xl border-2 border-gray-100 dark:border-gray-700">
      <div className="flex items-center justify-between mb-8">
        <h3 className="md:text-3xl text-lg font-bold text-gray-900 dark:text-white">Activity Overview</h3>
        <div className="flex items-center space-x-2 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 rounded-full px-4 py-2">
      ...
      <div className="space-y-8">
        {chartData.map((item, index) => (
          <div key={index} className={`${item.bgColor} rounded-2xl p-6 border-2 border-opacity-20`}>
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center space-x-4">
                <div className={`w-6 h-6 bg-gradient-to-r ${item.color} rounded-full shadow-lg`}></div>
              ...
              <div className="flex items-center space-x-8">
                <div className="text-right">
                  ...
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{item.recent}</p>
                </div>
                <div className="text-right">
            ...
            <div className="relative">
              ...
              <div className="absolute top-0 h-4 flex items-center" style={{ left: `${(item.recent / maxValue) * 100}%` }}>
